...
class Atualizafrmt:
    ...
    def __init__(self, master, mainwin):
        ...
        self.master.title("Atualização de ferramentas")
        self.master.geometry("960x540")
        self.master.resizable(False, False)
        self.master.configure(bg='#3E6676')
        self.master.pack_propagate(False)
        style = ttk.Style()
        style.theme_use('clam')
        self.center_frame = Frame(
            self.master, relief='raised', background='#3E6676')
        ...
        user_profile = os.environ['USERPROFILE'] + '\Documents\\ferramentas.csv'
